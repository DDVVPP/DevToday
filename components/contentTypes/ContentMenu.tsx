  ...
  return (
    <>
      <DropdownMenu>
        ...
        >
          <div
            className="relative flex cursor-pointer items-center gap-x-3 p-3 hover:rounded hover:bg-white-200 hover:p-3 hover:duration-300 dark:hover:bg-dark-700"
            onClick={() =>
              router.push(
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger
              className="flex cursor-pointer items-center gap-x-3 p-3 hover:rounded hover:bg-white-200 hover:p-3 hover:duration-300 dark:hover:bg-dark-700"
