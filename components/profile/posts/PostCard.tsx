...
const PostCard = ({ post, userData, index = 1 }: PostCardProps) => {
  return (
    post && (
      ...
      >
        <div
          className={`group min-h-[200px] cursor-pointer gap-x-5 gap-y-2.5 rounded-[16px] bg-white-100 p-5 text-dark-800 transition duration-300 dark:bg-dark-800 dark:text-white-100 dark:hover:bg-dark-700`}
        >
