...
const LikeButton = ({
  ...
  const heartBackground = {
    ...
    none: "rounded transition duration-300 group-hover:bg-white-200 dark:group-hover:bg-dark-700",
  };
  ...
  return (
    <div className="group">
      ...
      >
        <Heart
          size={size}
          className={`${isPending ? "animate-pulse" : ""} transition duration-300 group-hover:fill-primary-500 ${
            isLiked
              ? "fill-primary-500"
              : heartBgType === "none"
                ? "fill-white-300"
