...
const Date = ({ startTime }: { startTime: Date }) => {
  ...
  return (
    <div className="flex size-[60px] flex-col  content-center items-center justify-center rounded-[6px] bg-white-200 px-4 py-1 duration-300 group-hover:bg-white-100 dark:bg-dark-700 dark:group-hover:bg-dark-800">
